...
<html>
    ...
    <!-- Style format for deleteShop and the navbar  -->
    <style>
       body{
    height: 100vh;
...
.navbar a:hover {
    ...
    <body>
        ...
        <div class="navbar">
         ...
         <div id="new-info">
            <div id="title">Delete item</div>
         
            <form action="deleteShopConfirm.jsp" method="post">
			<div id="input">
	
				<span id="info"><strong>Please provide the ID of shop item you would like to delete:</strong></span>
